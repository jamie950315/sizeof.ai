...
describe('model KV cache', () => {
  it('uses the v5 namespace so older partial artifact data cannot shadow validated results', () => {
    expect(createModelKvKey('meta-models', 'Muse-Glimmer-30B')).toBe('model-response-v5:meta-models/Muse-Glimmer-30B')
  })
