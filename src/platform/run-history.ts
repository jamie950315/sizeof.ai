import { buildDeploymentPlan, deploymentModelId, restoreDeployment, type DeploymentInput } from './deployment'
...
export interface RunArtifact { repositoryId: string; path: string; revision: string; sizeBytes: number; sourceModelId: string; checkedAt: string }
